...
const messages = {
  'zh-CN': {
    ...
    toast: {
      ...
      pathTracingBuilding: '正在构建光线追踪场景',
      pathTracingOff: '光线追踪已关闭',
      pathTracingOn: '光线追踪已开启，画面将渐进清晰',
      pathTracingUnavailable: '当前设备无法启用光线追踪',
      reset: '车辆与镜头已复位',
      unlocked: '车辆已解锁',
    },
    aria: {
  ...
  'en-US': {
    ...
    toast: {
      partState: '{part} {state}',
      pathTracingBuilding: 'Building the path-traced scene',
      pathTracingOff: 'Path tracing disabled',
      pathTracingOn: 'Path tracing enabled; the image will refine progressively',
      pathTracingUnavailable: 'Path tracing is unavailable on this device',
